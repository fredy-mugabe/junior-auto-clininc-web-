/** Stroke-style icons for a classic, consistent look across pages. */
...
export function IconGauge({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconEngine({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M4 10h2l2-3h8l2 3h2a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-2l-1 2H7l-1-2H4a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2Z" />
...
export function IconAward({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconNotebook({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconGraduation({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconSparkle({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="m12 3-1.9 5.8-6.1 2 6.1 2L12 21l1.9-8.2 6.1-2-6.1-2L12 3Z" />
    </svg>
  )
}
